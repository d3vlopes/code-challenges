...
export type NewsletterManyWhereInput = {
	...
	/** All values containing the given string. */
	track_contains?: InputMaybe<Scalars['String']['input']>;
	/** All values ending with the given string. */
	track_ends_with?: InputMaybe<Scalars['String']['input']>;
	/** All values that are contained in given list. */
	track_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
	/** Any other value that exists and is not equal to the given value. */
	track_not?: InputMaybe<Scalars['String']['input']>;
	/** All values not containing the given string. */
	track_not_contains?: InputMaybe<Scalars['String']['input']>;
	/** All values not ending with the given string */
	track_not_ends_with?: InputMaybe<Scalars['String']['input']>;
	/** All values that are not contained in given list. */
	track_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
	/** All values not starting with the given string. */
	track_not_starts_with?: InputMaybe<Scalars['String']['input']>;
	/** All values starting with the given string. */
	track_starts_with?: InputMaybe<Scalars['String']['input']>;
	updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
	/** All values greater than the given value. */
	updatedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
	/** All values greater than or equal the given value. */
...
export type ScheduledOperationAffectedDocument = Asset | Newsletter;
...
export type AddNewsletterMutationVariables = Exact<{
	name: Scalars['String']['input'];
	email: Scalars['String']['input'];
	track: Scalars['String']['input'];
}>;

export type AddNewsletterMutation = {
	__typename?: 'Mutation';
	createNewsletter?: { __typename?: 'Newsletter'; id: string } | null;
};

export const AddNewsletterDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'AddNewsletter' },
			variableDefinitions: [
				{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'createNewsletter' },
						arguments: [
							{
								kind: 'Argument',
	...
	AddNewsletterMutationVariables
>;
